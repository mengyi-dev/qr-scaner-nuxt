<template>
  <div>
    <div class="max-w-[576px] relative mx-auto h-screen bg-slate-900  px-5 py-10">
      ...
      <section class="flex gap-4 mx-auto w-fit">
        <div class="flex flex-col gap-1 w-[77px] items-center justify-center cursor-pointer">
          ...
          <p class="text-slate-200 text-sm">Flash</p>
        </div>
        <label for="upload" class="flex flex-col gap-1 w-[78px] items-center justify-center cursor-pointer">
          <div class="text-slate-300 bg-slate-700 w-fit p-2 rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
          ...
          <p class="text-slate-200 whitespace-nowrap text-sm">Upload QR</p>
        </label>
      </section>
      <div v-show="isOpen">
    ...
    <ImageBarcodeReader @result="onDecode" />
  </div>
</template>
